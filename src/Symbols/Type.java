...
public class Type {
    ...
    public boolean isEmptyPointerType() {
        return this.isPointer && this.type == PType.VOID;
    }

    public boolean isPrimitiveType() {
        return this.type != PType.VOID;
    }

    public boolean isNumericType() {
        return this.type == PType.INT || this.type == PType.FLOAT;
    }
